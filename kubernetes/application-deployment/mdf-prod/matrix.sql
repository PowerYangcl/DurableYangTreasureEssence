...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`matrix` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
) ENGINE=InnoDB AUTO_INCREMENT=819 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `ac_api_info` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=80161092 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='alter table `ac_api_info` AUTO_INCREMENT=80160001';
...
CREATE TABLE `gw_route` (
  ...
  `uri` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '路由转发路径',
  `active` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '环境：dev|test|pre|master or prod',
  ...
  `description` varchar(52) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '描述',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` bigint DEFAULT '0' COMMENT '创建人id',
  `create_user_name` varchar(20) DEFAULT '' COMMENT '创建人姓名',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `gw_route_predicates` (
  ...
  `predicate_value` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '断言规则对应值',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` bigint DEFAULT '0' COMMENT '创建人id',
  `create_user_name` varchar(20) DEFAULT '' COMMENT '创建人姓名',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `gw_route_rate_flow_key_words` (
  ...
  `route_id` varchar(52) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '关联外键',
...
CREATE TABLE `job_group` (
  ...
  `ip` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '该分组所在主机IP|逗号分隔',
...
CREATE TABLE `job_info` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='定时任务列表';
...
CREATE TABLE `mc_goods_purchase` (
  ...
  `pic_url` varchar(512) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '采购商品图片，多图以逗号分隔',
  `purchase_type` int DEFAULT '1' COMMENT '采购类型，1-大棚生产物资 2-员工福利商品 3-员工食堂物资 4-办公耗材(纸张/油墨/门锁/饮用水) 5-拜访客户礼品 6-敬老助学礼品',
  `purchase_channle` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '采购渠道：京东|淘宝|拼多多|阿里巴巴|实体商户',
  ...
  `invoice_url` varchar(512) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '发票图片，多图以逗号分隔。采购负责人进行更新。',
  ...
  `remark` varchar(52) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '备注，实际入库数量与采购数量不一致需要描述清楚，货物破损是否重发了',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` bigint DEFAULT '0' COMMENT '创建人id',
  `create_user_name` varchar(20) DEFAULT '' COMMENT '创建人姓名',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `mc_role_function` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20499 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `mc_sys_function` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1177 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `mc_user_info` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'zid',
  `user_name` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '系统用户登录名',
  `password` varchar(45) DEFAULT '' COMMENT '密码',
  `type` varchar(20) DEFAULT 'user' COMMENT 'leader Leader后台用户|admin 其他平台管理员|user其他平台用户',
  `platform` varchar(152) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'P01' COMMENT '平台标识码,逗号分隔|leader类型用户只能分配【矩阵分布式框架控制台】这个系统。',
  ...
  `mobile` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '手机号',
  `email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '邮箱',
  `qq` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT 'qq号码',
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20072026234195 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='API表格';
...
CREATE TABLE `mc_user_info_ext` (
  ...
  `merit` varchar(4) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT 'B' COMMENT '员工当前年度绩效(即总评，不同于季度绩效)：D(无法胜任工作或效率明显低下)/C(客诉10次以上)/B-(客诉10次以内)/B(客诉5次以内)/A(无客诉或重要责任事故)/A+(突出贡献)',
  `premium` int DEFAULT '100' COMMENT '五险一金缴纳比例，0~100代表百分比',
  `any_past_history_of_illness` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '过往疾病史，此处为描述文本',
...
CREATE TABLE `mc_user_merit` (
  ...
  `merit` varchar(4) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'B' COMMENT '季度绩效得分：A+(突出贡献)/A(无客诉或重要责任事故)/B(客诉5次以内)/B-(客诉10次以内)/C(客诉10次以上)/D(无法胜任工作或效率明显低下)',
  `remark` varchar(255) DEFAULT '' COMMENT '绩效评语，阐述绩效得分原因',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` bigint DEFAULT '0' COMMENT '创建人id',
  `create_user_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '创建人姓名|绩效评定人',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_user_id` bigint DEFAULT '0' COMMENT '更新人id',
  `update_user_name` varchar(20) DEFAULT '' COMMENT '更新者姓名',
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
...
CREATE TABLE `mc_user_org_info` (
  ...
  `name` varchar(52) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '乡镇/村/棚区编号|生产岗位/大棚编号|岗位点',
  `level` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT 'town:乡镇名称;village:村名称;area:棚区编号/生产岗位，比如：A区/游乐场;num:大棚编号 1,2,3等',
  `full_name` varchar(52) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT 'org_type=num时记录完整名称，比如：漷县镇-草厂村-A棚区-1号棚/漷县镇-草厂村-餐厅名-后厨',
...
CREATE TABLE `mc_user_org_position` (
  ...
  `ext_type` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT 'position|org',
  `mc_user_id` bigint NOT NULL COMMENT '用户id',
...
CREATE TABLE `mc_user_position` (
  ...
  `position_level` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '职级：职员/经理/总经理/副总/CEO/董事长 |学员/初级培育员/中级培育员/高级培育员/技术专家 | 中级/高级/资深/架构',
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` bigint DEFAULT '1' COMMENT '创建人id',
  `create_user_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'admin' COMMENT '创建人姓名',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_user_id` bigint DEFAULT '1' COMMENT '更新人id',
  `update_user_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'admin' COMMENT '更新者姓名',
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`)
...
CREATE TABLE `mc_user_salary_log` (
  ...
  `month` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '薪资发放月份',
  ...
  `penalty_reason` varchar(52) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '' COMMENT '罚款金额原因',
  `remark` varchar(52) DEFAULT '' COMMENT '备注',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` bigint DEFAULT '0' COMMENT '创建人id',
  `create_user_name` varchar(20) DEFAULT '' COMMENT '创建人姓名',
...
CREATE TABLE `mc_workflow_purchase` (
  ...
  `name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '流转记录名称，如：一级审批、二级审批、入库等等',
  `mc_user_id` bigint NOT NULL COMMENT '流程处理人员ID',
  `process_user_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '流程处理人员真实名称',
...
CREATE TABLE `mc_workflow_template` (
  ...
  `level` varchar(4) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '1' COMMENT '节点等级 1-模板名称 2-工作流过程描述',
  `template_code` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '当前工作流模板编码，方便获取数据使用',
